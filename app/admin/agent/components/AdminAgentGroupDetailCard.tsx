...
import AdminAgentCreateForm from "./AdminAgentCreateForm";
...
export default function AdminAgentGroupDetailCard() {
  ...
  const agentSelect = useAgentListQuery({ page: 1, take: 100 }, { enabled: memberDialogOpen });
  ...
  return (
    <>
      ...
      {memberDialogOpen ? (
        <AdminModalDialog title="멤버 추가" onClose={resetMemberDialog}>
